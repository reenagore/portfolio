...
import { deleteEvent, getAdminEvents } from "../../services/events.service";
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between pl-6">
          <div>
            ...
            <p className="mt-2 text-indigo-900/70">
              Manage event landing pages and their details
            </p>
          </div>

          <Link
            to="/admin/landing-pages/events/new"
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-indigo-100 bg-white p-12">
            ...
            <p className="mt-2 text-sm text-indigo-900/60">
              {searchTerm || filterStatus !== "all" 
                ...
                : "Get started by creating your first event landing page"}
            </p>
            {(searchTerm || filterStatus !== "all") && (
              <button
                onClick={() => {
              ...
              <div className="relative">
                <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                      ...
                      <div>
                        ...
                        <div className="mt-3">
                          <span className="text-sm font-medium text-[#FFD700]">
                            {item.price > 0 ? `${item.currency || "KES"} ${item.price.toLocaleString()}` : "Free Event"}
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-2">
                    <Link
                      to={`/admin/landing-pages/events/${item._id}/edit`}

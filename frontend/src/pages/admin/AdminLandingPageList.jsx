...
export default function AdminLandingPagesList({ forcedType = "" }) {
  ...
  const fetchItems = async () => {
    try {
      const res = await getAdminLandingPages(
  ...
  const getTypeColor = (type) => {
    switch(type) {
      ...
      case 'product': return "text-indigo-600";
      case 'gallery': return "text-[#FFD700]";
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between pl-6">
          <div>
            ...
            <p className="mt-2 text-indigo-900/70">
              Manage event, product, and gallery pages
            </p>
          </div>
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-indigo-100 bg-white p-12">
            ...
            <h3 className="mt-4 font-serif text-xl font-semibold text-black">No landing pages found</h3>
              ...
              <div className="relative">
                <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                      ...
                      <div>
                        ...
                        <div className="mt-2 flex flex-wrap items-center gap-3 text-sm">
                          <span className={`flex items-center gap-1 ${getTypeColor(item.type)}`}>
                            {getTypeIcon(item.type)}
                            <span className="capitalize text-indigo-900/60">{item.type}</span>
                          </span>
                  ...
                  <div className="flex items-center gap-2">
                    <Link
                      to={`/admin/landing-pages/${item._id}/edit`}
        ...
        <div className="rounded-xl border border-indigo-100 bg-indigo-50/30 px-6 py-4">
          <div className="flex items-center justify-between">
            <p className="text-sm text-indigo-900/60">
              Showing {filteredItems.length} of {items.length} landing pages
            </p>

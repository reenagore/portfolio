...
import { submitProgramRegistration } from "../../services/registration.service";
...
export default function ProgramRegistrationForm({ program }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await submitProgramRegistration({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-indigo-100 bg-white/80 p-6 backdrop-blur-sm shadow-lg shadow-indigo-900/5 transition-all duration-300 hover:border-[#FFD700] hover:shadow-xl hover:shadow-[#FFD700]/10 md:p-8">
      ...
      <div className="relative">
        ...
        <div className="flex items-start gap-3 mb-6">
          <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#FFD700]/20 to-indigo-900/20">
            <svg className="h-5 w-5 text-[#FFD700]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M15 5v2m0 4v2m0 4v2M5 5h14a2 2 0 012 2v3a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2zm0 8h14a2 2 0 012 2v3a2 2 0 01-2 2H5a2 2 0 01-2-2v-3a2 2 0 012-2z" />
            </svg>
          </div>
          <div>
        ...
        {/* Success Message */}
        {successMessage && (
          <div className="mb-6 rounded-xl border border-emerald-200 bg-emerald-50/90 p-4 text-sm text-emerald-700 backdrop-blur-sm animate-slideDown">
        ...
        <form onSubmit={handleSubmit} className="grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <div className="relative group/input">
              ...
              <textarea
                name="message"
                placeholder="Tell us more about your interest in this program..."
        ...
        <p className="mt-6 text-center text-xs text-indigo-900/40">
          By submitting this form, you agree to receive communication about this program.

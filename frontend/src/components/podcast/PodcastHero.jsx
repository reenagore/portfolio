export default function PodcastPageHero() {
    return (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col items-center justify-center gap-4 sm:flex-row pt-4">
                ...
                <a
                  href="https://www.youtube.com/@reena.leadershipcoaching"
                  className="group inline-flex items-center justify-center rounded-xl border border-white/30 bg-white/10 backdrop-blur-sm px-8 py-4 text-sm font-medium text-white transition-all duration-200 hover:border-[#FFD700] hover:bg-white/20 hover:shadow-lg hover:shadow-[#FFD700]/10 min-w-[200px]"
                >
                  Subscribe Now
